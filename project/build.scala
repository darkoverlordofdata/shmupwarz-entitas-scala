...
/** RoboVM is kaput. No new projects */
...
object Settings {
  ...
  lazy val core = plugins.JvmPlugin.projectSettings ++ Seq(
    ...
    libraryDependencies ++= Seq(
      "com.darkoverlordofdata" % "entitas_2.11" % "0.0.0-SNAPSHOT",
      "com.underwaterapps.overlap2druntime" % "overlap2d-runtime-libgdx" % "0.1.2-SNAPSHOT",
  ...
  lazy val android = core ++ Tasks.natives ++ androidBuild ++ Seq(
    libraryDependencies ++= Seq(
      ...
      "com.badlogicgames.gdx" % "gdx-freetype-platform" % libgdxVersion.value % "natives" classifier "natives-armeabi",
      "com.badlogicgames.gdx" % "gdx-freetype-platform" % libgdxVersion.value % "natives" classifier "natives-armeabi-v7a",
      "com.badlogicgames.gdx" % "gdx-freetype-platform" % libgdxVersion.value % "natives" classifier "natives-x86"
    ),
